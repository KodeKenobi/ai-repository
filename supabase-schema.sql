...
CREATE INDEX idx_business_insights_company_id ON business_insights(company_id);
CREATE INDEX idx_consistency_reports_user_id ON consistency_reports(user_id);
CREATE INDEX idx_gap_analysis_reports_user_id ON gap_analysis_reports(user_id);
