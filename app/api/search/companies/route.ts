      ...
      if (isFullyPopulated) {
        ...
        const { data: updatedCompany, error: updateError } = await supabaseAdmin
          ...
          .update({
            ...
            glassdoor_rating: glassdoorRating || existingCompany.glassdoor_rating,
            google_rating: googleRating || existingCompany.google_rating,
            trustpilot_score: trustpilotScore || existingCompany.trustpilot_score,
            bbb_rating: bbbRating || existingCompany.bbb_rating,
            yelp_rating: yelpRating || existingCompany.yelp_rating,
            industry_reviews: industryReviews || existingCompany.industry_reviews,
            ...
            geographic_presence: geographicPresence || existingCompany.geographic_presence,
            ...
            competitive_advantage: competitiveAdvantage || existingCompany.competitive_advantage,
            industry_ranking: industryRanking || existingCompany.industry_ranking,
            ...
            speaking_engagements: speakingEngagements || existingCompany.speaking_engagements,
            technology_stack: technologyStack || existingCompany.technology_stack,
            patents: patents || existingCompany.patents,
            rd_investment: rdInvestment || existingCompany.rd_investment,
            innovation_areas: innovationAreas || existingCompany.innovation_areas,
            tech_partnerships: techPartnerships || existingCompany.tech_partnerships,
            esg_score: esgScore || existingCompany.esg_score,
            sustainability_initiatives: sustainabilityInitiatives || existingCompany.sustainability_initiatives,
            corporate_values: corporateValues || existingCompany.corporate_values,
            diversity_inclusion: diversityInclusion || existingCompany.diversity_inclusion,
            social_impact: socialImpact || existingCompany.social_impact,
            office_locations: officeLocations || existingCompany.office_locations,
            remote_work_policy: remoteWorkPolicy || existingCompany.remote_work_policy,
            ...
            investment_thesis: investmentThesis || existingCompany.investment_thesis,
            due_diligence_notes: dueDiligenceNotes || existingCompany.due_diligence_notes,
          })
          .eq('name', name)
          .select()
          .single();
